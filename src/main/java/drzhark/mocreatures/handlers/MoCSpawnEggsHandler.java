...
public class MoCSpawnEggsHandler extends Item {

    public Class<? extends Entity> entityClass;

    public MoCSpawnEggsHandler(Class<? extends Entity> entityClass) {
    ...
    private String getEntityTextureName(Class<? extends Entity> entityClass) {
        ...
        return MoCreatures.MODID + ":" + "egg" + lowerCaseEntityClassName;
    }
}
