...
public class MoCreatures {
    ...
    public void registerEntities() {
        registerEntity(MoCEntityBunny.class, "Bunny");
        registerEntity(MoCEntitySnake.class, "Snake");
        registerEntity(MoCEntityTurtle.class, "Turtle");
        registerEntity(MoCEntityBird.class, "Bird");
        registerEntity(MoCEntityMouse.class, "Mouse");
        registerEntity(MoCEntityTurkey.class, "Turkey");
        registerEntity(MoCEntityHorse.class, "WildHorse");
        registerEntity(MoCEntityHorseMob.class, "HorseMob");
        registerEntity(MoCEntityOgre.class, "Ogre");
        registerEntity(MoCEntityBoar.class, "Boar");
        registerEntity(MoCEntityBear.class, "Bear");
        registerEntity(MoCEntityDuck.class, "Duck");
        registerEntity(MoCEntityBigCat.class, "BigCat");
        registerEntity(MoCEntityDeer.class, "Deer");
        registerEntity(MoCEntityWWolf.class, "WWolf");
        registerEntity(MoCEntityWraith.class, "Wraith");
        registerEntity(MoCEntityFlameWraith.class, "FlameWraith");
        registerEntity(MoCEntityFox.class, "Fox");
        registerEntity(MoCEntityWerewolf.class, "Werewolf");
        registerEntity(MoCEntityShark.class, "Shark");
        registerEntity(MoCEntityDolphin.class, "Dolphin");
        registerEntity(MoCEntityFishy.class, "Fishy");
        registerEntity(MoCEntityKitty.class, "Kitty");
        registerEntity(MoCEntityKittyBed.class, "KittyBed");
        registerEntity(MoCEntityLitterBox.class, "LitterBox");
        registerEntity(MoCEntityRat.class, "Rat");
        registerEntity(MoCEntityHellRat.class, "HellRat");
        registerEntity(MoCEntityScorpion.class, "Scorpion");
        registerEntity(MoCEntityCrocodile.class, "Crocodile");
        registerEntity(MoCEntityRay.class, "Ray");
        registerEntity(MoCEntityJellyFish.class, "JellyFish");
        registerEntity(MoCEntityGoat.class, "Goat");
        registerEntity(MoCEntityEgg.class, "Egg");
        registerEntity(MoCEntityFishBowl.class, "FishBowl");
        registerEntity(MoCEntityOstrich.class, "Ostrich");
        registerEntity(MoCEntityBee.class, "Bee");
        registerEntity(MoCEntityFly.class, "Fly");
        registerEntity(MoCEntityDragonfly.class, "DragonFly");
        registerEntity(MoCEntityFirefly.class, "Firefly");
        registerEntity(MoCEntityCricket.class, "Cricket");
        registerEntity(MoCEntitySnail.class, "Snail");
        registerEntity(MoCEntityButterfly.class, "ButterFly");
        registerEntity(MoCEntityThrowableRock.class, "TRock");
        registerEntity(MoCEntityGolem.class, "BigGolem");
        registerEntity(MoCEntityPetScorpion.class, "PetScorpion");
        registerEntity(MoCEntityPlatform.class, "MoCPlatform");
        registerEntity(MoCEntityElephant.class, "Elephant");
        registerEntity(MoCEntityKomodo.class, "KomodoDragon");
        registerEntity(MoCEntityWyvern.class, "Wyvern");
        registerEntity(MoCEntityRoach.class, "Roach");
        registerEntity(MoCEntityMaggot.class, "Maggot");
        registerEntity(MoCEntityCrab.class, "Crab");
        registerEntity(MoCEntityRaccoon.class, "Raccoon");
        registerEntity(MoCEntityMiniGolem.class, "MiniGolem");
        registerEntity(MoCEntitySilverSkeleton.class, "SilverSkeleton");
        registerEntity(MoCEntityAnt.class, "Ant");
        registerEntity(MoCEntityMediumFish.class, "MediumFish");
        registerEntity(MoCEntitySmallFish.class, "SmallFish");
        registerEntity(MoCEntityPiranha.class, "Piranha");
        registerEntity(MoCEntityEnt.class, "Ent");
        registerEntity(MoCEntityMole.class, "Mole");
