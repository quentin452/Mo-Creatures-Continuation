...
public class EntityData {
    ...
    private final List<BiomeGenBase> spawnBiomes = new ArrayList<BiomeGenBase>();
    private List<String> biomeGroups = new ArrayList<String>();
    private final Map<String, List<BiomeGenBase>> biomeGroupSpawnMap = new HashMap<String, List<BiomeGenBase>>();
